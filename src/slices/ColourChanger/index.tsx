...
export type ColourChangerProps =
  SliceComponentProps<Content.ColourChangerSlice>;


const ColourChanger: FC<ColourChangerProps> = ({ slice }) => {
  ...
  return (
    ...
    >
      ...
      <Bounded className="relative shrink-0" innerClassName="flex flex-col lg:flex-row gap-6 lg:gap-8">
        ...
        <ul className="grid grow grid-col-2 gap-3 rounded-2xl bg-white p-4 text-black shadow-lg sm:grid-cols-3 md:grid-cols-6 lg:grid-cols-3 xl:grid-cols-6 ">
            ...
            <li key={texture.id}>
              ...
              className={clsx("flex aspect-square flex-col items-center justify-center rounded-lg border-2 p-4 hover:scale-105 motion-safe:transition-all motion-safe:durtion-300",
                ...
                <div className="mb-3 overflow-hidden rounded border-2 border-black bg-gray-100">
                  <img src={texture.path}  alt={texture.name} width={400} height={255}
